...
set_property PACKAGE_PIN M14 [get_ports {LD[3]}]
set_property PACKAGE_PIN N16 [get_ports {LD[2]}]
set_property PACKAGE_PIN P14 [get_ports {LD[1]}]
set_property PACKAGE_PIN R14 [get_ports {LD[0]}]
